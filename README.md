...
│   │   │   ├── cli/
│   │   │   │   ├── dte.c 🔐
│   │   │   │   └── dte.exe ⌨️ 🟣 <-- Предоставляет комплект инструментов как для прикладных, так и системных задач
│   │   │   └── gui/
│   │   │       ├── <s>dte.c 🔐</s>
│   │   │       └── <s>dte.exe 🖱️</s> 🟣 <-- Предоставляет комплект инструментов как для прикладных, так и системных задач
│   │   ├── <s>dte-cli.c 🔐</s>
│   │   ├── <s>dte-cli.exe ⌨️</s> 🟣 <-- Предоставляет комплект инструментов как для прикладных, так и системных задач
│   │   ├── <s>dte-gui.c 🔐</s>
│   │   └── <s>dte-gui.exe 🖱️</s> 🟣 <-- Предоставляет комплект инструментов как для прикладных, так и системных задач
