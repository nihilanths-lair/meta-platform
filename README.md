...
│   │   ├── app/ 🟡 <-- Этот компонент необходим для скачивания исключительно прикладным разработчикам
│   │   │   ├── ui/
│   │   │   │   ├── cli/
│   │   │   │   │   ├── adte.c 🔐
│   │   │   │   │   └── adte.exe ⌨️
...
│   │   │   ├── <s>sdte-gui.c 🔐</s>
│   │   │   └── <s>sdte-gui.exe 🖱️</s>
│   │   ├── ui/ 🟣 <-- Этот компонент необходим для скачивания как прикладным, так и системным разработчикам
│   │   │   ├── cli/
│   │   │   │   ├── dte.c 🔐
│   │   │   │   └── dte.exe ⌨️
│   │   │   └── gui/
