...
int main()
{
    ...
    case 4: ip--; // использовать только в режиме ручного управления (для избежания багов)
    case 5: ip++; // использовать только в режиме ручного управления (для избежания багов)
