...
int main(int argc, char *argv[])
{
    ...
    const unsigned char fch[256] =
    {
        ...
        0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0xA8, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
        // 0xB0 - 0xBF (Пробелы, на индексе 0xB8 стоит строчная 'ё')
        0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0xB8, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
